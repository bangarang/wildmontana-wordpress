...
namespace Flynt\Components\TrailPhotosLatest;

use Flynt\FieldVariables;
use Flynt\Utils\Options;
use Timber\Timber;

const POST_TYPE = 'trail_photo';

add_filter('Flynt/addComponentData?name=TrailPhotosLatest', function ($data) {
    $postType = POST_TYPE;
...
{
    return [
        'name' => 'TrailPhotosLatest',
        'label' => 'Trail Photos Latest',
        'sub_fields' => [
            [
