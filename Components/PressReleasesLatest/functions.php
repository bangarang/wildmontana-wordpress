...
namespace Flynt\Components\PressReleasesLatest;
...
add_filter('Flynt/addComponentData?name=PressReleasesLatest', function ($data) {
    $postType = POST_TYPE;
...
{
    return [
        'name' => 'PressReleasesLatest',
        'label' => 'Press Releases Latest',
        'sub_fields' => [
            [
