...
function registerTrailPostType()
{
    $labels = [
        'name'                  => _x('Trails', 'Trail General Name', 'flynt'),
        'singular_name'         => _x('Trail', 'Trail Singular Name', 'flynt'),
        'menu_name'             => __('Trails', 'flynt'),
        'name_admin_bar'        => __('Trail', 'flynt'),
    ...
    $args = [
        'label'                 => __('Trail', 'flynt'),
        'description'           => __('Trail Description', 'flynt'),
        'labels'                => $labels,
...
add_action('init', '\\Flynt\\CustomPostTypes\\registerTrailPostType');
